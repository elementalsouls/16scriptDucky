...
Simply upload Ducky-microSD to your arduino, forma your microSD to FAT32 and save your script on the microSD card titled script.txt
Lastly, connect a microsd breakout board using the pins below

****Connection of Arduino and microSD module****
```
...
I have seen some ducky scripts that put hyphens (-) in between keys to be pressed simultaneously eg."CTRL-ALT DELETE". Note that when using ducky-microSD you must not use hyphens and instead just use spaces eg."CTRL ALT DELETE"
